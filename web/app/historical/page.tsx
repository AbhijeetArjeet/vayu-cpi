...
export default function HistoricalPage() {
  ...
  useEffect(() => {
    ...
    fetchHistoricalAnalytics(orig, dest).then((res) => {
      setAnalytics(res);
      setLoading(false);
    });
  }, [selectedRoute]);
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 font-mono">
                ...
                <div className="glass-panel p-5 bg-slate-900/80 border-slate-800 lg:col-span-2">
                  ...
                  <div className="space-y-4">
                    {analytics.histogram.map((bin: any, idx: number) => {
                      const maxCount = Math.max(...analytics.histogram.map((b: any) => b.count), 1);
                ...
                <div className="glass-panel p-5 bg-slate-900/80 border-slate-800">
                  ...
                  <div className="space-y-3">
                    {analytics.airline_rankings.map((air: any, idx: number) => (
                      <div
                        key={idx}
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs">
                    ...
                    <tbody className="divide-y divide-slate-800/60">
                      {analytics.route_rankings.map((r: any, idx: number) => (
