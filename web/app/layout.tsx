...
export const metadata: Metadata = {
  ...
  description: "Real-Time Airfare Price Index for India (SIH26056) - MoSPI Macro CPI & DGCA Surge Anomaly Matrix",
};
        ...
        <ThemeProvider>
          ...
          <footer className="border-t border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-950 py-6 text-center text-xs font-mono text-slate-500 dark:text-slate-400">
            <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
              <span>VAYU-CPI • Real-Time Airfare Price Index for India (Problem Statement SIH26056)</span>
