...
const MOCK_CPI_SERIES: NationalCompositeCPI[] = [
  { calculation_date: '2024-01-01', composite_index: 100.0, advance_sub_index: 100.0, spot_sub_index: 100.0, tracked_corridors: 6, dgca_traffic_coverage_pct: 100.0 },
  { calculation_date: '2024-02-01', composite_index: 102.5, advance_sub_index: 101.5, spot_sub_index: 103.5, tracked_corridors: 6, dgca_traffic_coverage_pct: 100.0 },
  { calculation_date: '2024-03-01', composite_index: 105.1, advance_sub_index: 103.0, spot_sub_index: 108.0, tracked_corridors: 6, dgca_traffic_coverage_pct: 100.0 },
  { calculation_date: '2024-04-01', composite_index: 104.2, advance_sub_index: 102.5, spot_sub_index: 106.5, tracked_corridors: 6, dgca_traffic_coverage_pct: 100.0 },
];
...
const MOCK_SURGE_ALERTS: SurgeAlert[] = [
  ...
  { corridor: 'DEL-PAT', origin: 'DEL', destination: 'PAT', current_fare: 9500, baseline_30d_fare: 6800, sigma_deviation: 3.1, severity: 'MODERATE', carrier_dominance: 'IndiGo (70%)', flagged_at: new Date().toISOString() }
];

const MOCK_FEE_DECOMPOSITION: FeeDecomposition[] = [
  { route: 'DEL-BOM', base_fare: 4500, fuel_surcharge_yq: 600, airport_fee_udf: 650, convenience_fee: 300 },
  { route: 'BLR-DEL', base_fare: 5000, fuel_surcharge_yq: 600, airport_fee_udf: 580, convenience_fee: 300 },
  { route: 'DEL-CCU', base_fare: 3500, fuel_surcharge_yq: 600, airport_fee_udf: 480, convenience_fee: 300 },
  { route: 'DEL-PAT', base_fare: 4200, fuel_surcharge_yq: 600, airport_fee_udf: 350, convenience_fee: 300 },
  { route: 'BOM-GOI', base_fare: 3100, fuel_surcharge_yq: 600, airport_fee_udf: 390, convenience_fee: 300 },
];
